...
import CourseVideo from '../assets/senhas_seguras.mp4';

import Video from 'react-native-video';

const SenhasSegurasScreen = ({navigation}) => {
  return (
          ...
          <View style={styles.firewallContainer}>
            ...
            <View style={{flexDirection: 'column'}}>
              ...
              <Text style={styles.displayNameText3}>
                Utilização e criação de senhas seguras.
              </Text>
            </View>
          </View>
          <View>
...
export default SenhasSegurasScreen;
