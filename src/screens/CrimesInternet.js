...
import CourseVideo from '../assets/crimes_internet_leis.mp4';

import Video from 'react-native-video';

const CrimesInternetScreen = ({navigation}) => {
  return (
...
export default CrimesInternetScreen;
